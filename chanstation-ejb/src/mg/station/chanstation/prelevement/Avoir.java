...
public class Avoir {
    ...
    public Avoir(FactureClient factureClient, String idClient, String idProduit, String montant) {
    ...
    public AvoirFC creerAvoirFC(Connection tsotra,Connection connection) throws Exception {
        ...
        try{
            ...
            avoirFC.setDesignation("Avoir du prelevement du "+this.getFactureClient().getPrelevement().getDaty().toString()+" "+this.getFactureClient().getPrelevement().getId_prelevement());
            avoirFC.setIdMagasin(cuve.getId_cuve());
            avoirFC.setEtat(1);
            avoirFC.setIdOrigine(this.getFactureClient().getPrelevement().getId_prelevement());
    ...
    public Carburant getCarburantByPrelevement(Prelevement prelevement,Connection connection) throws Exception {
        ...
        Cuve cuve = pompe.getCuveByIdPompe(pompe.getId_pompe(),connection);
    ...
    public boolean estPermis(Connection connection) throws Exception {
        ...
        return sum + this.getMontant() < getCarburantByPrelevement(this.getFactureClient().getPrelevement(),connection).getPu_vente() * this.getFactureClient().getPrelevement().getCompteur();
    }
    ...
    public AvoirFCFille[] genererFilles(Connection tsotra,Connection connection) throws Exception {
        ...
        avoirFCFille.setIdProduit(cuve.getId_carburant());
        ...
        avoirFCFille.setIdOrigine(this.getFactureClient().getPrelevement().getId_prelevement());
    ...
    public double getSommeAvoirByOrigine(Connection connection) throws Exception {
        AvoirFCFille[] avoirFCFilles = (AvoirFCFille[])  CGenUtil.rechercher(new AvoirFCFille(),null,null,connection," and idOrigine='"+factureClient.getPrelevement().getId_prelevement()+"'");
        this.qteAvoir = 0;
    ...
    public double getCorrespondingQuantity(Prelevement prelevement,Carburant carburant,Pompe pompe,Connection connection) throws Exception {
        ...
        System.out.println("QTE ANT:"+prelevementAnt.getCompteur());
        double qtyVente = (prelevement.getCompteur()-prelevementAnt.getCompteur());
