...
public class Encaissement {
    ...
    public boolean estEncaisse(Connection connection) throws Exception {
        MvtCaisse[] mvtCaisses = (MvtCaisse[]) CGenUtil.rechercher(new MvtCaisse(),null,null,connection," and idOrigine='"+this.getFactureClient().getPrelevement().getId_prelevement()+"'");
